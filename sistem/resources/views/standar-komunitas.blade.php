...
<head>
    <!-- Title -->
    <title>Standar Komunitas | One Click Democracy</title>
        ...
        <div class="header-section">
            <div id="basicLogoAndNav" class="container">
                ...
                <nav class="js-mega-menu navbar navbar-expand-lg">
                    <!-- Logo -->
                    <a class="navbar-brand" href="index.html" aria-label="OCD">
                        <img src="img/logo.png" alt="Logo" style="width: 105px;">
                    </a>
                    <!-- End Logo -->
                    ...
                    <div id="navBarBasic" class="collapse navbar-collapse">
                        <ul class="navbar-nav">
                            <li class="navbar-nav-item">
                                <a class="nav-link" href="ketentuan-layanan.html">Ketentuan Layanan</a>
                            </li>
                            <li class="navbar-nav-item">
                                <a class="nav-link" href="mengelola-akun.html">Mengelola Akun</a>
                            </li>
                            <li class="navbar-nav-item">
                                <a class="nav-link" href="menggunakan-ocd.html">Menggunakan OCD</a>
                            </li>
                            <li class="navbar-nav-item">
                                <a class="nav-link" href="standar-komunitas.html">Standar Komunitas</a>
                            </li>

                            <li class="nav-item navbar-nav-last-item">
                                <a class="btn btn-sm btn-primary transition-3d-hover btn-pill" href="index.html">
                                Goto main site
                                </a>
                            </li>
                        </ul>
    ...
    <main id="content" role="main">
                        ...
                        <div class="js-sticky-block card-border" data-hs-sticky-block-options='{
                            ...
                            <div class="container js-scroll bg-white rouded shadow-lg">
                                <ul class="js-scroll-nav p-2 nav nav-sm nav-x-0 flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link large font-weight-bold mb-2" href="#pendahuluan" style="font-size: 1rem;">Pendahuluan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link font-weight-bold mb-2" href="#bagian-i-akun" style="font-size: 1rem">Bagian I Akun</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link font-weight-bold mb-2" href="#bagian-ii-konten" style="font-size: 1rem">Bagian II Konten</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link font-weight-bold mb-2" href="#permintaan-pengguna" style="font-size: 1rem">Permintaan Pengguna</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link font-weight-bold mb-2" href="#informasi-tambahan" style="font-size: 1rem">Informasi Tambahan</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class=" container space-top-2 space-top-md-1">
            <div class="row justify-content-end">
                ...
                <div class="col-md-7 col-lg-8">
                    <!-- Section One -->
                    <div id="pendahuluan" class="space-1">
                    ...
                    <!-- Section Two -->
                    <div id="bagian-i-akun" class="space-1">
                    ...
                    <!-- Section Three -->
                    <div id="bagian-ii-konten" class="space-1">
                    ...
                    <!-- Section Four -->
                    <div id="permintaan-pengguna" class="space-1">
                    ...
                    <!-- Section Five -->
                    <div id="informasi-tambahan" class="space-1">
                            ...
                            <li class="list-inline-item">
                                <div class="hs-unfold">
                                    <a class="js-hs-unfold-invoker dropdown-toggle btn btn-xs btn-soft-secondary" href="javascript:;" data-hs-unfold-options='{
                                        ...
                                        <img class="dropdown-item-icon" src="{{ asset('assets/vendor/flag-icon-css/flags/4x3/us.svg') }}" alt="United States Flag">
